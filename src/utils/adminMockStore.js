...
const defaultSidebarNav = [
  ...
  { id: 'kbPwaDesign', groupKey: 'learning', groupTitle: '学习与文档', groupIcon: '📚', groupOrder: 2, tabOrder: 5 },
  ...
  { id: 'hostServices', groupKey: 'workbench', groupTitle: '工作台', groupIcon: '🏠', groupOrder: 1, tabOrder: 3 },
